	...
	$(window).on('load', function () {
				...
				$('.samplevoice .play').on('touchend click',function(event){
					...
					if(ss.includes(true)&&(t==cv)){
						...
						switch(t){
							...
							//クロエ
							case 'chloe1' :
							console.log(t,'クロエボイス1再生');
							ins_sv[0].play();
							break;

							case 'chloe2' :
							console.log(t,'クロエボイス2再生');
							ins_sv[1].play();
							break;

							//コーコ
							case 'coco1' :
							console.log(t,'コーコボイス1再生');
							ins_sv[2].play();
							break;

							case 'coco2' :
							console.log(t,'コーコボイス2再生');
							ins_sv[3].play();
							break;

							//ノア
							case 'noa1' :
							console.log(t,'ノアボイス1再生');
							ins_sv[4].play();
							break;

							case 'noa2' :
							console.log(t,'ノアボイス2再生');
							ins_sv[5].play();
							break;

							//アニマ
							case 'anima1' :
							console.log(t,'アニマボイス1再生');
							ins_sv[6].play();
							break;

							case 'anima2' :
							console.log(t,'アニマボイス2再生');
							ins_sv[7].play();
							break;

							//ヤマト
							case 'yamato1' :
							console.log(t,'ヤマトボイス1再生');
							ins_sv[8].play();
							break;

							case 'yamato2' :
							console.log(t,'ヤマトボイス2再生');
							ins_sv[9].play();
							break;

							//アオバ
							case 'aoba1' :
							console.log(t,'アオバボイス1再生');
							ins_sv[10].play();
							break;

							case 'aoba2' :
							console.log(t,'アオバボイス2再生');
							ins_sv[11].play();
							break;

							//ジュリィ
							case 'julie1' :
							console.log(t,'ジュリィボイス1再生');
							ins_sv[12].play();
							break;

							case 'julie2' :
							console.log(t,'ジュリィボイス2再生');
							ins_sv[13].play();
							break;

							//デイター
							case 'deiter1' :
							console.log(t,'デイターボイス1再生');
							ins_sv[14].play();
							break;

							case 'deiter2' :
							console.log(t,'デイターボイス2再生');
							ins_sv[15].play();
							break;
		...
		*/
		if($('#deletecookies').length){
			...
			console.log('Cookie処理開始');


			var cookielist = ['cookie_choice_fv','cookie_vote','cookie_test']; //発行Cookieキー
			var count = 0; //保存Cookieカウント用


			for(let i=0; i<cookielist.length; i++){

				if(($.cookie(cookielist[i]))!==undefined){
					count++;
					console.log('保存されているCookieをカウント')
				}
			...
			//Cookie状態を表示
			$('.function .status').text('SaveCookie：'+count);


			//削除処理
			$('#deletecookies').on('touchstart click', function(){
				...
				for(let i=0; i<cookielist.length; i++){
					...
					if(($.cookie(cookielist[i]))!==undefined){
						...
						console.log('Cookieを消去');
					}

				}

				alert('Deleted cookies stored on altdeus.com');
